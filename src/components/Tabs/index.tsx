            ...
            <span className={`flex ${styles.scroll}`}>
                {
                    childList.map((child: any) => {
                        return (
                            <span className={`flex-no-shrink flex flex-column ${styles.titlewrapper}`}
                                onClick={onTitleChange.bind(null, child)}>
                                <span className={`${styles.title} ${activeName === child.props.name ? styles.activetitle : ""}`}>
                                    {
                                        child.props.title
                                    }
                                </span>
                                <span className={activeName === child.props.name ? styles.activebar : ""} />
                            </span>
                        )
                    })
                }
