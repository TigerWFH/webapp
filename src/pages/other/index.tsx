		...
		return (
			<div>
				<button className={styles.button}
					onClick={this.onToAnimation}>
					animation（动画）
				</button>
				<button className={styles.button}
					onClick={this.onToAntd}>
					antd
				</button>
				<button className={styles.button}
					onClick={this.onToBones}>
					bones（骨架图）
				</button>
				<button className={styles.button}
					onClick={this.onToChild}>
					child
				</button>
				<button className={styles.button}
					onClick={this.onToContext}>
					context
				</button>
				<button className={styles.button}
					onClick={this.onToDetail}>
					detail
				</button>
				<button className={styles.button}
					onClick={this.onToEchat}>
					echat
				</button>
				<button className={styles.button}
					onClick={this.onToHooks}>
					hooks
				</button>
				<button className={styles.button}
					onClick={this.onToMiddle}>
					middle
				</button>
				<button className={styles.button}
					onClick={this.onToSignature}>
					signture
				</button>
				<button className={styles.button}
					onClick={this.onToStartApp}>
					startapp
				</button>
				<button className={styles.button}
					onClick={this.onToState}>
					state
				</button>
				<button className={styles.button}
					onClick={this.onToVideo}>
					video
				</button>
			</div>
		);
